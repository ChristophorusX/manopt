...
@function
def getGlobalDefaults(*args,**kwargs):
    varargin = getGlobalDefaults.varargin
    nargin = getGlobalDefaults.nargin
...
# Change log:
    ...
    opts.verbosity = copy(3)
# getGlobalDefaults.m:28
    
    # debugging information is outputed during solver execution.
    opts.debug = copy(false)
# getGlobalDefaults.m:32
    ...
    opts.storedepth = copy(20)
# getGlobalDefaults.m:38
    
    opts.maxtime = copy(inf)
# getGlobalDefaults.m:41
    return opts
