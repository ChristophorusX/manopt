...
@function
def canGetPrecon(problem=None,*args,**kwargs):
    varargin = canGetPrecon.varargin
    nargin = canGetPrecon.nargin
...
# Change log:
    ...
    candoit=isfield(problem,'precon') or canGetSqrtPrecon(problem)
# canGetPrecon.m:19
    return candoit
