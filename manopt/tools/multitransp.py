...
@function
def multitransp(a=None,dim=None,*args,**kwargs):
    varargin = multitransp.varargin
    nargin = multitransp.nargin
...
# multitransp.m:34
    ...
    # Transposing
    order=matlabarray(cat(arange(1,dim - 1),dim + 1,dim,arange(dim + 2,ndims(a))))
# multitransp.m:37
    b=permute(a,order)
# multitransp.m:38
    return b
